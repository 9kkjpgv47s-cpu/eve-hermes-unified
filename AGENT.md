...
- Horizon: see **`agent.md`** and **`docs/HORIZON_STATUS.json`** (terminal program horizon is **H35** as of the latest roadmap closeout; `AGENT.md` defers to those for horizon index).
