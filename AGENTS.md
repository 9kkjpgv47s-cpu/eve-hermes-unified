...
#   --require-goal-policy-coverage --goal-policy-coverage-until-horizon H9 --require-policy-tagged-targets
# optionally require the readiness-audit gate before promotion:
#   --require-goal-policy-readiness-audit --goal-policy-readiness-audit-max-target-horizon H9 --require-goal-policy-readiness-tagged-targets
...
npm run audit:goal-policy-readiness -- --horizon-status-file docs/HORIZON_STATUS.json --source-horizon H2 --until-horizon H9 --require-tagged-requirements
