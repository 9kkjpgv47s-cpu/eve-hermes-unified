...
npm run validate:goal-policy-file -- --horizon-status-file docs/HORIZON_STATUS.json --goal-policy-file docs/GOAL_POLICIES.json --source-horizon H2 --until-horizon H8 --require-tagged-requirements --require-positive-pending-min
...
npm run check:goal-policy-coverage -- --source-horizon H2 --until-horizon H8 --require-positive-pending-min --horizon-status-file docs/HORIZON_STATUS.json
