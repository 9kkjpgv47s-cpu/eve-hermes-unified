...
Long-horizon status lives in `docs/HORIZON_STATUS.json` (currently **H1–H30 completed** with **post-H30 terminal sustainment**). After `npm install`, periodic operators/agents should:
