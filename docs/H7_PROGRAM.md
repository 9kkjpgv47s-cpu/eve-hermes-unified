...
See **`docs/HORIZON_STATUS.json`** for **`h7-action-*`** status, **`docs/H8_PROGRAM.md`** for the H8 program, and **`docs/GOAL_POLICIES.json`** for **`H6->H7`** and **`H7->H8`** transition policies.
