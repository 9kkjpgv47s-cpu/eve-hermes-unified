...
`npm run validate:dispatch-contract` validates every `test/fixtures/unified-dispatch-result-v*.json` file with `validateUnifiedDispatchResult` (see `docs/DISPATCH_CONTRACT_V1.md`).
