...
## Phase 8 - Post-H36 sustainment (continuous)

After horizon **H36** is completed in `docs/HORIZON_STATUS.json`, operators and agents should periodically confirm the sustainment bundle still passes end-to-end:
