...
- `--goal-policy-file <path>` to load transition policies from a dedicated policy document
  ...
  - `--goal-policy-file-validation-until-horizon <H3|H4|H5|H6|H7|H8|H9|H10|H11>` to set validation transition scope
...
- `--require-goal-policy-readiness-audit` to run `audit:goal-policy-readiness` as an explicit promotion gate
  ...
  - add `--goal-policy-readiness-audit-max-target-horizon <H3|H4|H5|H6|H7|H8|H9|H10|H11>` (alias of `--goal-policy-readiness-audit-until-horizon`) to define readiness-audit transition window
