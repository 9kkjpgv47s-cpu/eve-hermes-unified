...
function parseArgs(argv) {
  const options = {
    ...
    goalPolicyCoverageUntilHorizon: "H9",
  ...
  const payload = {
    ...
    checks: {
      ...
      goalPolicyCoverageUntilHorizon:
        options.requireGoalPolicyCoverage === true
          ? normalizeHorizon(options.goalPolicyCoverageUntilHorizon, nextHorizon || "H9") || null
          : null,
      requiredPolicyTransitions:
      ...
      goalPolicyFileValidationUntilHorizon:
        options.requireGoalPolicyFileValidation === true
          ? normalizeHorizon(options.goalPolicyFileValidationUntilHorizon, nextHorizon || "H9") || null
          : null,
      ...
      goalPolicyReadinessAuditUntilHorizon:
        options.requireGoalPolicyReadinessAudit === true
          ? normalizeHorizon(options.goalPolicyReadinessAuditUntilHorizon, nextHorizon || "H9") || null
          : null,
