...
function parseArgs(argv) {
  const options = {
    ...
    goalPolicyCoverageUntilHorizon: "H8",
  ...
  const payload = {
    ...
    checks: {
      ...
      goalPolicyCoverageUntilHorizon:
        options.requireGoalPolicyCoverage === true
          ? normalizeHorizon(options.goalPolicyCoverageUntilHorizon, nextHorizon || "H8") || null
          : null,
      requiredPolicyTransitions:
      ...
      goalPolicyFileValidationUntilHorizon:
        options.requireGoalPolicyFileValidation === true
          ? normalizeHorizon(options.goalPolicyFileValidationUntilHorizon, nextHorizon || "H8") || null
          : null,
      ...
      goalPolicyReadinessAuditUntilHorizon:
        options.requireGoalPolicyReadinessAudit === true
          ? normalizeHorizon(options.goalPolicyReadinessAuditUntilHorizon, nextHorizon || "H8") || null
          : null,
