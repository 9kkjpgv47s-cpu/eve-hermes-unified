...
function parseArgs(argv) {
  const options = {
    ...
    goalPolicyCoverageUntilHorizon: "H11",
  ...
  const payload = {
    ...
    checks: {
      ...
      goalPolicyCoverageUntilHorizon:
        options.requireGoalPolicyCoverage === true
          ? normalizeHorizon(options.goalPolicyCoverageUntilHorizon, nextHorizon || "H11") || null
          : null,
      requiredPolicyTransitions:
      ...
      goalPolicyFileValidationUntilHorizon:
        options.requireGoalPolicyFileValidation === true
          ? normalizeHorizon(options.goalPolicyFileValidationUntilHorizon, nextHorizon || "H11") || null
          : null,
      ...
      goalPolicyReadinessAuditUntilHorizon:
        options.requireGoalPolicyReadinessAudit === true
          ? normalizeHorizon(options.goalPolicyReadinessAuditUntilHorizon, nextHorizon || "H11") || null
          : null,
