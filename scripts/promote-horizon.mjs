...
function parseArgs(argv) {
  const options = {
    ...
    goalPolicyCoverageUntilHorizon: "H7",
  ...
  const payload = {
    ...
    checks: {
      ...
      goalPolicyCoverageUntilHorizon:
        options.requireGoalPolicyCoverage === true
          ? normalizeHorizon(options.goalPolicyCoverageUntilHorizon, nextHorizon || "H7") || null
          : null,
      requiredPolicyTransitions:
      ...
      goalPolicyFileValidationUntilHorizon:
        options.requireGoalPolicyFileValidation === true
          ? normalizeHorizon(options.goalPolicyFileValidationUntilHorizon, nextHorizon || "H7") || null
          : null,
      ...
      goalPolicyReadinessAuditUntilHorizon:
        options.requireGoalPolicyReadinessAudit === true
          ? normalizeHorizon(options.goalPolicyReadinessAuditUntilHorizon, nextHorizon || "H7") || null
          : null,
