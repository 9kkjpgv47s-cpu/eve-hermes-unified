#!/usr/bin/env node
/**
 * Horizon H20 assurance bundle: H19 gates plus evidence manifest schema sweep (fail-closed
 * validation over evidence/ after the full terminal chain).
 */
...
const payload = {
  ...
  horizon: "H20",
  pass: h19Bundle.pass && manifestSchemas.pass,
  checks: {
    h19AssuranceBundlePass: h19Bundle.pass,
    manifestSchemasPass: manifestSchemas.pass,
  },
  steps: [h19Bundle, manifestSchemas],
};
