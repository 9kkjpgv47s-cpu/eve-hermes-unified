#!/usr/bin/env node
/**
 * Horizon H21 assurance bundle: H20 gates plus final horizon-status re-validation after the
...
const payload = {
  ...
  horizon: "H21",
  pass: h20Bundle.pass && horizonStatusRecheck.pass,
  checks: {
    h20AssuranceBundlePass: h20Bundle.pass,
    horizonStatusRecheckPass: horizonStatusRecheck.pass,
  },
  steps: [h20Bundle, horizonStatusRecheck],
};
