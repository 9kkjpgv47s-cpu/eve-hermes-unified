#!/usr/bin/env node
/**
 * Horizon H22 assurance bundle: H21 gates plus evidence manifest schema sweep (fail-closed
 * validation over evidence/ after the H21 terminal slice).
 */
...
const payload = {
  ...
  horizon: "H22",
  pass: h21Bundle.pass && manifestSchemas.pass,
  checks: {
    h21AssuranceBundlePass: h21Bundle.pass,
    manifestSchemasPass: manifestSchemas.pass,
  },
  steps: [h21Bundle, manifestSchemas],
};
