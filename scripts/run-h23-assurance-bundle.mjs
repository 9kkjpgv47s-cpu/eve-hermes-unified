#!/usr/bin/env node
/**
 * Horizon H23 assurance bundle: H22 gates plus final horizon-status re-validation after the
...
const payload = {
  ...
  horizon: "H23",
  pass: h22Bundle.pass && horizonStatusRecheck.pass,
  checks: {
    h22AssuranceBundlePass: h22Bundle.pass,
    horizonStatusRecheckPass: horizonStatusRecheck.pass,
  },
  steps: [h22Bundle, horizonStatusRecheck],
};
