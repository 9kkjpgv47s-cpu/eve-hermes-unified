#!/usr/bin/env node
/**
 * Horizon H23 assurance bundle: full post-H22 terminal sustainment chain plus an evidence-dir
...
const postH22 = runStep("run_post_h22_sustainment_loop", [
  process.execPath,
  path.join(root, "scripts/run-post-h22-sustainment-loop.mjs"),
]);
...
const payload = {
  ...
  horizon: "H23",
  pass: postH22.pass && manifestSchemas.pass,
  checks: {
    postH22SustainmentLoopPass: postH22.pass,
    manifestSchemasPass: manifestSchemas.pass,
  },
  steps: [postH22, manifestSchemas],
};
