#!/usr/bin/env node
/**
 * Horizon H25 assurance bundle: full post-H24 terminal sustainment chain plus an evidence-dir
...
const postH24 = runStep("run_post_h24_sustainment_loop", [
  process.execPath,
  path.join(root, "scripts/run-post-h24-sustainment-loop.mjs"),
]);
...
const payload = {
  ...
  horizon: "H25",
  pass: postH24.pass && manifestSchemas.pass,
  checks: {
    postH24SustainmentLoopPass: postH24.pass,
    manifestSchemasPass: manifestSchemas.pass,
  },
  steps: [postH24, manifestSchemas],
};
