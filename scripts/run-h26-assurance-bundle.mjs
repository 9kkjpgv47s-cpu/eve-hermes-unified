#!/usr/bin/env node
/**
 * Horizon H26 assurance bundle: H25 gates plus evidence manifest schema sweep (fail-closed
 * validation over evidence/ after the H25 terminal slice).
 */
