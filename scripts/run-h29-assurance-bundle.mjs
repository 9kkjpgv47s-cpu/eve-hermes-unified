#!/usr/bin/env node
/**
 * Horizon H29 assurance bundle: full post-H28 terminal sustainment chain plus an evidence-dir
...
const postH28 = runStep("run_post_h28_sustainment_loop", [
  process.execPath,
  path.join(root, "scripts/run-post-h28-sustainment-loop.mjs"),
]);
...
const payload = {
  ...
  horizon: "H29",
  pass: postH28.pass && manifestSchemas.pass,
  checks: {
    postH28SustainmentLoopPass: postH28.pass,
    manifestSchemasPass: manifestSchemas.pass,
  },
  steps: [postH28, manifestSchemas],
};
