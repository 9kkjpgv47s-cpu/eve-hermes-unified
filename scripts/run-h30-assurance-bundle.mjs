#!/usr/bin/env node
/**
 * Horizon H30 assurance bundle: H29 gates plus evidence manifest schema sweep (fail-closed
 * validation over evidence/ after the H29 terminal slice).
 */
