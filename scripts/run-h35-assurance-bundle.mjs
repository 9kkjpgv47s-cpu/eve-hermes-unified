#!/usr/bin/env node
/**
 * Horizon H35 assurance bundle: full post-H34 terminal sustainment chain plus an evidence-dir
...
const postH34 = runStep("run_post_h34_sustainment_loop", [
  process.execPath,
  path.join(root, "scripts/run-post-h34-sustainment-loop.mjs"),
]);
...
const payload = {
  ...
  horizon: "H35",
  pass: postH34.pass && manifestSchemas.pass,
  checks: {
    postH34SustainmentLoopPass: postH34.pass,
    manifestSchemasPass: manifestSchemas.pass,
  },
  steps: [postH34, manifestSchemas],
};
