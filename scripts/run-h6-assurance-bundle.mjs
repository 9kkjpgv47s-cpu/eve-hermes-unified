 ...
 *
 * Tenant/region gates (**`validate:tenant-isolation`**, **`rehearse:region-failover`**) and unified entrypoints (**`validate:unified-entrypoints`**) run in **`run-h20-assurance-bundle.mjs`** after **`validate:all`** + **`npm run build`** (terminal assurance chain).
 */
