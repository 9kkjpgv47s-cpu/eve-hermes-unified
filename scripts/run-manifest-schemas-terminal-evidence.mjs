#!/usr/bin/env node
/**
 * Records evidence for validate:manifest-schemas on the newest post-H26 sustainment loop (H27 closeout).
 * Runs **`npm run validate:manifest-schemas`**, validates newest **`post-h26-sustainment-loop-*.json`**, writes **`evidence/manifest-schemas-terminal-evidence-*.json`**.
 */
