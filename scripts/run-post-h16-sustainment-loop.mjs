#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H37 chains H36→…→H16),
...
const assurance = runNpm("run:h37-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h37_assurance_bundle", ...assurance },
