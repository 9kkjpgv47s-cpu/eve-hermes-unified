#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H31 chains H30→…→H16),
...
const assurance = runNpm("run:h31-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h31_assurance_bundle", ...assurance },
