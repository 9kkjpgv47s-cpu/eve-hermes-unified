#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H39 chains H38→…→H16),
...
const assurance = runNpm("run:h39-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h39_assurance_bundle", ...assurance },
