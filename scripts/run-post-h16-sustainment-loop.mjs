#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H28 chains H27→…→H16),
...
const assurance = runNpm("run:h28-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h28_assurance_bundle", ...assurance },
