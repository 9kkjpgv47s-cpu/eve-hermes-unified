#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H24 chains H23→…→H16),
...
const assurance = runNpm("run:h24-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h24_assurance_bundle", ...assurance },
