#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H27 chains H26→…→H16),
...
const assurance = runNpm("run:h27-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h27_assurance_bundle", ...assurance },
