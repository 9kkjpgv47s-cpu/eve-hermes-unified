#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H35 chains H34→…→H16),
...
const assurance = runNpm("run:h35-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h35_assurance_bundle", ...assurance },
