#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H25 chains H24→…→H16),
...
const assurance = runNpm("run:h25-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h25_assurance_bundle", ...assurance },
