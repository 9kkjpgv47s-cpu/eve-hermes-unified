#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H29 chains H28→…→H16),
...
const assurance = runNpm("run:h29-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h29_assurance_bundle", ...assurance },
