#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H33 chains H32→…→H16),
...
const assurance = runNpm("run:h33-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h33_assurance_bundle", ...assurance },
