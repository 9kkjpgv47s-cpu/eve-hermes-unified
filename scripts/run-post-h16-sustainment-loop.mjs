#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H26 chains H25→…→H16),
...
const assurance = runNpm("run:h26-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h26_assurance_bundle", ...assurance },
