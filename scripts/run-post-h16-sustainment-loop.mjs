#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H41 chains H40→…→H16),
...
const assurance = runNpm("run:h41-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h41_assurance_bundle", ...assurance },
