#!/usr/bin/env node
/**
 * Post-H16 sustainment loop: horizon metadata, terminal assurance bundle (H30 chains H29→…→H16),
...
const assurance = runNpm("run:h30-assurance-bundle");
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_h30_assurance_bundle", ...assurance },
