#!/usr/bin/env node
/**
 * Legacy post-H22 sustainment loop (pre-H23). Prefer **`npm run verify:sustainment-loop`** (post-H23).
 *
 * Chains **`validate:horizon-status`** + H17/H18 + CI soak + entrypoints + shell CI + tenant isolation + **`validate:h22-closeout`**.
 */
