#!/usr/bin/env node
/**
 * Legacy post-H23 sustainment loop (pre-H24). Prefer **`npm run verify:sustainment-loop`** (post-H24).
 *
 * Chains **`validate:horizon-status`** + **`run:h23-assurance-bundle`** + **`validate:h23-closeout`**.
 */
