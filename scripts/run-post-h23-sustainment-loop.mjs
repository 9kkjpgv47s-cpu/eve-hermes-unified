#!/usr/bin/env node
/**
 * Post-H23 sustainment loop: same terminal chain as post-H22, plus H23 assurance bundle
 * (post-H22 + manifest schemas) and H23 closeout gate.
 *
...
const assuranceH23 = runNode("scripts/run-h23-assurance-bundle.mjs");
