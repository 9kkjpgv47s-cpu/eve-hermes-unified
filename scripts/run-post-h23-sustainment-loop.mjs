#!/usr/bin/env node
/**
 * Post-H23 sustainment loop: horizon metadata, H17 merge-bundle assurance, H18 cutover rehearsal,
 * CI soak SLO drift gate, unified entrypoints evidence, shell unified-dispatch CI scan evidence,
 * evidence-gates cross-check, tenant isolation evidence, H23 closeout gate.
 *
