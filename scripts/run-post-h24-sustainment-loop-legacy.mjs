#!/usr/bin/env node
/**
 * Legacy post-H24 sustainment loop (pre-H25). Prefer **`npm run verify:sustainment-loop`** (post-H25).
 *
 * Chains **`validate:horizon-status`** + **`run:h24-assurance-bundle`** + **`validate:h24-closeout`**.
 */
