#!/usr/bin/env node
/**
 * Post-H24: post-H23 chain + region failover evidence + H24 closeout.
 */
...
const region = runNpm("run:region-failover-evidence");
const closeout = runNpm("validate:h24-closeout");

const postH23ChainPass = postH23.exitCode === 0;
const regionFailoverEvidencePass = region.exitCode === 0;
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_region_failover_evidence", ...region },
