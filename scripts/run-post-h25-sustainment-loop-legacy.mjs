#!/usr/bin/env node
/**
 * Legacy post-H25 sustainment loop (pre-H26). Prefer **`npm run verify:sustainment-loop`** (post-H26).
 *
 * Chains **`validate:horizon-status`** + **`run:h25-assurance-bundle`** + **`validate:h25-closeout`**.
 */
