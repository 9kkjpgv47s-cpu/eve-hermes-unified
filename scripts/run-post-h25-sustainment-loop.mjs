#!/usr/bin/env node
/**
 * Post-H25: post-H24 chain + agent remediation evidence + H25 closeout.
 */
...
const agent = runNpm("run:agent-remediation-evidence");
const closeout = runNpm("validate:h25-closeout");

const postH24ChainPass = postH24.exitCode === 0;
const agentRemediationEvidencePass = agent.exitCode === 0;
...
const manifest = {
  ...
  steps: [
    ...
    { id: "run_agent_remediation_evidence", ...agent },
