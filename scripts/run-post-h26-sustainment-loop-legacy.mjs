#!/usr/bin/env node
/**
 * Legacy post-H26 sustainment loop (pre-H27). Prefer **`npm run verify:sustainment-loop`** (post-H27).
 *
 * Chains **`validate:horizon-status`** + **`run:h26-assurance-bundle`** + **`validate:h26-closeout`**.
 */
