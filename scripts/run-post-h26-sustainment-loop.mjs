#!/usr/bin/env node
/**
 * Post-H26 sustainment loop: horizon metadata, H17/H18 merge and rehearsal gates, CI soak,
 * entrypoints + shell CI + tenant isolation, H26 terminal assurance bundle (H25 + horizon-status),
 * and H26 closeout gate.
 *
...
const assuranceH26 = runNode("scripts/run-h26-assurance-bundle.mjs");
