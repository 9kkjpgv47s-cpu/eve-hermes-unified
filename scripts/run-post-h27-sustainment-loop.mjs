#!/usr/bin/env node
/**
 * Post-H27 sustainment loop: same terminal chain as post-H26, plus H27 assurance bundle
 * (post-H26 + manifest schemas) and H27 closeout gate.
 *
...
const assuranceH27 = runNode("scripts/run-h27-assurance-bundle.mjs");
