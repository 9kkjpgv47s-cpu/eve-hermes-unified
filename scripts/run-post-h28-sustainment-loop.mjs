#!/usr/bin/env node
/**
 * Post-H28 sustainment: post-H27 chain + post-H27 manifest schema pin + stage-promotion sustainment + H28 closeout.
 */
...
const manifestPostH27 = runNpm("run:manifest-schemas-post-h27-loop-evidence");
const stagePromotion = runNpm("run:stage-promotion-sustainment-evidence");
const closeout = runNpm("validate:h28-closeout");

const postH27ChainPass = postH27.exitCode === 0;
const manifestSchemasPostH27LoopEvidencePass = manifestPostH27.exitCode === 0;
...
const manifest = {
  ...
  pass,
  checks: {
    postH27SustainmentChainPass: postH27ChainPass,
    manifestSchemasPostH27LoopEvidencePass,
    stagePromotionSustainmentEvidencePass,
    h28CloseoutGatePass,
  },
  steps: [
    ...
    { id: "run_manifest_schemas_post_h27_loop_evidence", ...manifestPostH27 },
