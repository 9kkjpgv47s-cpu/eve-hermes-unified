#!/usr/bin/env node
/**
 * Post-H28 sustainment loop: horizon metadata, H17/H18 merge and rehearsal gates, CI soak,
 * entrypoints + shell CI + tenant isolation, H28 terminal assurance bundle (H27 + horizon-status),
 * and H28 closeout gate.
 *
...
const assuranceH28 = runNode("scripts/run-h28-assurance-bundle.mjs");
