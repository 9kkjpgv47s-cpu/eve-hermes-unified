...
function commandVerificationType(command) {
  ...
  if (command === "node ./scripts/run-h21-assurance-bundle.mjs") {
    return "h21-assurance-bundle";
  }
  if (command === "node ./scripts/run-h22-assurance-bundle.mjs") {
    return "h22-assurance-bundle";
  }
...
function evaluateCommandPayload(command, payload, targetHorizon = "") {
  ...
  if (verificationType === "h17-assurance-bundle") {
    ...
    if (signal.h16AssuranceBundlePass !== true) {
      checks.push("h17_assurance_h16_bundle_not_passed");
    }
    if (signal.evidencePruneDryRunPass !== true) {
      checks.push("h17_assurance_evidence_prune_dry_run_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h18-assurance-bundle") {
    ...
    if (signal.h17AssuranceBundlePass !== true) {
      checks.push("h18_assurance_h17_bundle_not_passed");
    }
    if (signal.evidencePruneRehearsalPass !== true) {
      checks.push("h18_assurance_evidence_prune_rehearsal_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  ...
  if (verificationType === "h21-assurance-bundle") {
    const checks = [];
    if (payload.pass !== true) {
      checks.push("h21_assurance_bundle_not_passed");
    }
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h20AssuranceBundlePass !== true) {
      checks.push("h21_assurance_h20_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h21_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h22-assurance-bundle") {
    const checks = [];
    if (payload.pass !== true) {
      checks.push("h22_assurance_bundle_not_passed");
    }
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h21AssuranceBundlePass !== true) {
      checks.push("h22_assurance_h21_bundle_not_passed");
    }
    if (signal.manifestSchemasPass !== true) {
      checks.push("h22_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h23-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h22AssuranceBundlePass !== true) {
      checks.push("h23_assurance_h22_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h23_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h24-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h24_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h25-assurance-bundle") {
    ...
    if (signal.h24AssuranceBundlePass !== true) {
      checks.push("h25_assurance_h24_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h25_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h26-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h26_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h27-assurance-bundle") {
    ...
    if (signal.h26AssuranceBundlePass !== true) {
      checks.push("h27_assurance_h26_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h27_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h28-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h28_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h29-assurance-bundle") {
    ...
    if (signal.h28AssuranceBundlePass !== true) {
      checks.push("h29_assurance_h28_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h29_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h30-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h30_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h31-assurance-bundle") {
    ...
    if (signal.h30AssuranceBundlePass !== true) {
      checks.push("h31_assurance_h30_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h31_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h32-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h32_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h33-assurance-bundle") {
    ...
    if (signal.h32AssuranceBundlePass !== true) {
      checks.push("h33_assurance_h32_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h33_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  ...
  if (verificationType === "h36-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h36_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h37-assurance-bundle") {
    ...
    if (signal.h36AssuranceBundlePass !== true) {
      checks.push("h37_assurance_h36_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h37_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h38-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h38_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h39-assurance-bundle") {
    ...
    if (signal.h38AssuranceBundlePass !== true) {
      checks.push("h39_assurance_h38_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h39_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h40-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h40_assurance_manifest_schemas_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h41-assurance-bundle") {
    ...
    if (signal.h40AssuranceBundlePass !== true) {
      checks.push("h41_assurance_h40_bundle_not_passed");
    }
    if (signal.horizonStatusRecheckPass !== true) {
      checks.push("h41_assurance_horizon_status_recheck_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  ...
  if (verificationType === "post-h16-sustainment-loop") {
    ...
    if (signal.h16AssuranceBundlePass !== true && signal.terminalAssuranceBundlePass !== true) {
