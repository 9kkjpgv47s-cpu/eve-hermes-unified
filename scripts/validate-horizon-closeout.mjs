...
const HORIZON_SEQUENCE = ["H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8", "H9", "H10", "H11", "H12", "H13", "H14", "H15", "H16", "H17", "H18", "H19", "H20", "H21", "H22", "H23", "H24", "H25", "H26", "H27", "H28", "H29", "H30"];
...
function commandVerificationType(command) {
  ...
  if (command === "node ./scripts/run-post-h22-sustainment-loop-legacy.mjs") {
  ...
  if (command === "node ./scripts/run-post-h23-sustainment-loop-legacy.mjs") {
  ...
  if (command === "node ./scripts/run-post-h24-sustainment-loop-legacy.mjs") {
    return "post-h24-sustainment-loop";
  }
  ...
  if (command === "node ./scripts/run-post-h25-sustainment-loop-legacy.mjs") {
    return "post-h25-sustainment-loop";
  }
  ...
  if (command === "node ./scripts/run-post-h26-sustainment-loop-legacy.mjs") {
    return "post-h26-sustainment-loop";
  }
  ...
  if (command === "node ./scripts/run-post-h27-sustainment-loop-legacy.mjs") {
    return "post-h27-sustainment-loop";
  }
  ...
  if (command === "node ./scripts/run-post-h28-sustainment-loop-legacy.mjs") {
    return "post-h28-sustainment-loop";
  }
  ...
  if (command === "node ./scripts/run-post-h29-sustainment-loop-legacy.mjs") {
    return "post-h29-sustainment-loop";
  }
...
function evaluateCommandPayload(command, payload, targetHorizon = "") {
  ...
  if (verificationType === "h16-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.horizonStatusPass !== true) {
      checks.push("h16_assurance_horizon_status_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  ...
  if (verificationType === "h22-assurance-bundle") {
    ...
    if (signal.h17AssuranceBundlePass !== true) {
      checks.push("h22_assurance_h17_bundle_not_passed");
    }
    if (signal.h18AssuranceBundlePass !== true) {
      checks.push("h22_assurance_h18_bundle_not_passed");
    }
    if (signal.ciSoakSloGatePass !== true) {
      checks.push("h22_assurance_ci_soak_slo_gate_not_passed");
    }
    if (signal.shellUnifiedDispatchCiEvidencePass !== true) {
      checks.push("h22_assurance_shell_unified_dispatch_ci_evidence_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h23-assurance-bundle") {
    ...
    if (signal.goalPolicyFileValidationPass !== true) {
      checks.push("h23_assurance_goal_policy_file_validation_not_passed");
    }
    if (signal.manifestSchemasPass !== true) {
  ...
  if (verificationType === "h24-assurance-bundle") {
    ...
    if (signal.unifiedEntrypointsScanPass !== true) {
      checks.push("h24_assurance_unified_entrypoints_scan_not_passed");
    }
    if (signal.tenantIsolationValidationPass !== true) {
      checks.push("h24_assurance_tenant_isolation_validation_not_passed");
    }
    if (signal.regionFailoverRehearsalPass !== true) {
      checks.push("h24_assurance_region_failover_rehearsal_not_passed");
    }
  ...
  if (verificationType === "h25-assurance-bundle") {
    ...
    if (signal.h6AssuranceBundlePass !== true) {
      checks.push("h25_assurance_h6_bundle_not_passed");
    }
    if (signal.h16AssuranceBundlePass !== true) {
      checks.push("h25_assurance_h16_bundle_not_passed");
    }
  ...
  if (verificationType === "h26-assurance-bundle") {
    ...
    if (signal.stagePromotionReadinessPass !== true) {
      checks.push("h26_assurance_stage_promotion_readiness_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h27-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.horizonStatusValidationPass !== true) {
      checks.push("h27_assurance_horizon_status_validation_not_passed");
    }
  ...
  if (verificationType === "h28-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.initialScopeGatePass !== true) {
      checks.push("h28_assurance_initial_scope_gate_not_passed");
    }
  ...
  if (verificationType === "h29-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.releaseReadinessGatePass !== true) {
      checks.push("h29_assurance_release_readiness_gate_not_passed");
    }
  ...
  if (verificationType === "h30-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.validateAllGatePass !== true) {
      checks.push("h30_assurance_validate_all_gate_not_passed");
    }
