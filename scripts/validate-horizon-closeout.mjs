...
function evaluateCommandPayload(command, payload, targetHorizon = "") {
  ...
  if (verificationType === "h18-assurance-bundle") {
    ...
    if (signal.stagePromotionReadinessPass !== true) {
      checks.push("h18_assurance_stage_promotion_readiness_not_passed");
    }
    return { pass: checks.length === 0, checks };
  }
  if (verificationType === "h19-assurance-bundle") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.horizonStatusMetadataPass !== true) {
      checks.push("h19_assurance_horizon_status_metadata_not_passed");
    }
  ...
  if (verificationType === "h20-assurance-bundle") {
    ...
    if (signal.evidenceGatesPass !== true) {
      checks.push("h20_assurance_evidence_gates_not_passed");
    }
  ...
  if (verificationType === "h21-assurance-bundle") {
    ...
    if (signal.manifestSchemasPass !== true) {
      checks.push("h21_assurance_manifest_schemas_not_passed");
    }
  ...
  if (verificationType === "h22-assurance-bundle") {
    ...
    if (signal.unifiedEntrypointsPass !== true) {
      checks.push("h22_assurance_unified_entrypoints_not_passed");
    }
  ...
  if (verificationType === "h23-assurance-bundle") {
    ...
    if (signal.shellUnifiedDispatchCiScanPass !== true) {
      checks.push("h23_assurance_shell_unified_dispatch_ci_scan_not_passed");
    }
  ...
  if (verificationType === "post-h19-sustainment-loop") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h19AssuranceBundlePass !== true) {
      checks.push("post_h19_h19_assurance_bundle_not_passed");
    }
  ...
  if (verificationType === "post-h20-sustainment-loop") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h20AssuranceBundlePass !== true) {
      checks.push("post_h20_h20_assurance_bundle_not_passed");
    }
  ...
  if (verificationType === "post-h21-sustainment-loop") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h21AssuranceBundlePass !== true) {
      checks.push("post_h21_h21_assurance_bundle_not_passed");
    }
  ...
  if (verificationType === "post-h22-sustainment-loop") {
    ...
    const signal = payload.checks && typeof payload.checks === "object" ? payload.checks : {};
    if (signal.h22AssuranceBundlePass !== true) {
      checks.push("post_h22_h22_assurance_bundle_not_passed");
    }
