...
if (checks.postH27SustainmentLoopPass !== true) failures.push("postH27SustainmentLoopPass");
if (checks.evidenceSummaryEvidencePass !== true) failures.push("evidenceSummaryEvidencePass");
