#!/usr/bin/env node
/**
 * Validates the newest evidence/post-h29-sustainment-loop-*.json (after npm run verify:sustainment-loop).
 */
...
if (checks.postH28SustainmentLoopPass !== true) failures.push("postH28SustainmentLoopPass");
