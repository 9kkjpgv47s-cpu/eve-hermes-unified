...
if (checks.postH29SustainmentLoopPass !== true) failures.push("postH29SustainmentLoopPass");
if (checks.horizonStatusEvidencePass !== true) failures.push("horizonStatusEvidencePass");
