...
export type CapabilityExecutionDependencies = {
  ...
  /** 0 = unlimited. When set, execute() fails fast with policy_failure if executor exceeds budget. */
